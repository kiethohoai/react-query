...
function BlogsTable() {
  ...
  const { isPending, error, data } = useQuery({
    queryKey: ["fetchAllBlogPosts"],
    queryFn: async () =>
      await fetch("http://localhost:8000/blogs").then((res) => {
        return res.json();
      }),
  });
  ...
  return (
    <>
      ...
      <BlogCreateModal isOpenCreateModal={isOpenCreateModal} setIsOpenCreateModal={setIsOpenCreateModal} />
